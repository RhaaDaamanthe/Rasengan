...
<head>
    <meta charset="UTF-8">
    <title>Cartes Films - Catalogue</title>
...
<main>
    ...
    <div class="catalogue2">
        <?php foreach ($cartes as $carte): ?>
            <div class="card" data-film="<?= htmlspecialchars($carte->getFilm()->getNom()) ?>" data-rarete="<?= $carte->getRarete()->getId() ?>">
                <a href="/catalogue/film/carte/<?= $carte->getId() ?>">
